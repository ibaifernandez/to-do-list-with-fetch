...
export const TaskList = () => {																			// Declaration of 'Home' component
																										// Setting the variables which I'm gonna be using 
	...
	return (
		...
		<div className="container d-flex justify-content-center flex-column mx-auto bg-dark w-50 mt-3">
			<div className="d-flex justify-content-center flex-column mx-auto">
				<h1 className="my-3 text-info text-center">~ To Do List ~</h1>
				<input 
					type="text"
			...
			<div className="container text-center bg-dark mx-auto mt-3">
				<div className="d-flex justify-content-center flex-row">
					<ul className="p-0">
						{taskList.map((task, index) => (
						<li key={index} className="text-danger p-2">{task.label}
							<div className="d-flex justify-content-end flex-row bg-danger w-100 p-1">
							<div className="form-check">
								<input clasName="form-check-input" type="checkbox" value=""/>
							</div>
		...
		<div className="d-flex justify-content-center bg-light py-2 mx-auto my-3 px-3 fs-5 w-25" >{taskListLength} tasks left to do!</div></>);
};